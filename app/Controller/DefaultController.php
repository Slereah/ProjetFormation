...
class DefaultController extends Controller
{
	...
	public static function setWeatherIcon($code) 
	{
 		...
 		switch($code) 
 		{
		    case '0': $icon  = '<i class="wi-tornado"></i>';
		    break;
		    case '1': $icon  = '<i class="wi-storm-showers"></i>';
		    break;
		    case '2': $icon  = '<i class="wi-tornado"></i>';
		    break;
		    case '3': $icon  = '<i class="wi-thunderstorm"></i>';
		    break;
		    case '4': $icon  = '<i class="wi-thunderstorm"></i>';
		    break;
		    case '5': $icon  = '<i class="wi-snow"></i>';
		    break;
		    case '6': $icon  = '<i class="wi-rain-mix"></i>';
		    break;
		    case '7': $icon  = '<i class="wi-rain-mix"></i>';
		    break;
		    case '8': $icon  = '<i class="wi-sprinkle"></i>';
		    break;
		    case '9': $icon  = '<i class="wi-sprinkle"></i>';
		    break;
		    case '10': $icon  = '<i class="wi-hail"></i>';
		    break;
		    case '11': $icon  = '<i class="wi-showers"></i>';
		    break;
		    case '12': $icon  = '<i class="wi-showers"></i>';
		    break;
		    case '13': $icon  = '<i class="wi-snow"></i>';
		    break;
		    case '14': $icon  = '<i class="wi-storm-showers"></i>';
		    break;
		    case '15': $icon  = '<i class="wi-snow"></i>';
		    break;
		    case '16': $icon  = '<i class="wi-snow"></i>';
		    break;
		    case '17': $icon  = '<i class="wi-hail"></i>';
		    break;
		    case '18': $icon  = '<i class="wi-hail"></i>';
		    break;
		    case '19': $icon  = '<i class="wi-cloudy-gusts"></i>';
		    break;
		    case '20': $icon  = '<i class="wi-fog"></i>';
		    break;
		    case '21': $icon  = '<i class="wi-fog"></i>';
		    break;
		    case '22': $icon  = '<i class="wi-fog"></i>';
		    break;
		    case '23': $icon  = '<i class="wi-cloudy-gusts"></i>';
		    break;
		    case '24': $icon  = '<i class="wi-cloudy-windy"></i>';
		    break;
		    case '25': $icon  = '<i class="wi-thermometer"></i>';
		    break;
		    case '26': $icon  = '<i class="wi-cloudy"></i>';
		    break;
		    case '27': $icon  = '<i class="wi-night-cloudy"></i>';
		    break;
		    case '28': $icon  = '<i class="wi-day-cloudy"></i>';
		    break;
		    case '29': $icon  = '<i class="wi-night-cloudy"></i>';
		    break;
		    case '30': $icon  = '<i class="wi-day-cloudy"></i>';
		    break;
		    case '31': $icon  = '<i class="wi-night-clear"></i>';
		    break;
		    case '32': $icon  = '<i class="wi-day-sunny"></i>';
		    break;
		    case '33': $icon  = '<i class="wi-night-clear"></i>';
		    break;
		    case '34': $icon  = '<i class="wi-day-sunny-overcast"></i>';
		    break;
		    case '35': $icon  = '<i class="wi-hail"></i>';
		    break;
		    case '36': $icon  = '<i class="wi-day-sunny"></i>';
		    break;
		    case '37': $icon  = '<i class="wi-thunderstorm"></i>';
		    break;
		    case '38': $icon  = '<i class="wi-thunderstorm"></i>';
		    break;
		    case '39': $icon  = '<i class="wi-thunderstorm"></i>';
		    break;
		    case '40': $icon  = '<i class="wi-storm-showers"></i>';
		    break;
		    case '41': $icon  = '<i class="wi-snow"></i>';
		    break;
		    case '42': $icon  = '<i class="wi-snow"></i>';
		    break;
		    case '43': $icon  = '<i class="wi-snow"></i>';
		    break;
		    case '44': $icon  = '<i class="wi-cloudy"></i>';
		    break;
		    case '45': $icon  = '<i class="wi-lightning"></i>';
		    break;
		    case '46': $icon  = '<i class="wi-snow"></i>';
		    break;
		    case '47': $icon  = '<i class="wi-thunderstorm"></i>';
		    break;
		    case '3200': $icon  =  '<i class="wi-cloud"></i>';
		    break;
		    default: $icon  =  '<i class="wi-cloud"></i>';
		    break;
 		}
