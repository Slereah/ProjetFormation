						...
						<div class="col-md-4 col-md-offset-4">
							...
							<form method="post">
								...
								<div class="form-group welcome-image form-sign">
									...
									<input type="text" class="form-control" id="username" placeholder="Nom d'utilisateur" name="username" value="<?= $username ?>">
								</div>

								<div class="form-group welcome-image form-sign">
									<label for="lastname" class="control-label">Nom </label>
									<input type="text" class="form-control" id="lastname" placeholder="Nom" name="lastname" value="<?= $lastname ?>">
								</div>
